...
var _ExternalServices = _interopRequireDefault(
  require("./externalServices.js")
);
...
const productList = new _productList.default(
  category,
  dataSource,
...
document.querySelector("#listing-header").innerHTML += (0,
_utils.capitalizeFirstLetters)(capitalCategory);
